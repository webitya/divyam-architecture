        ...
        <>
            <main className="min-h-screen bg-black text-gray-300 py-24 px-6 md:px-20 leading-relaxed">
                <div className="max-w-4xl mx-auto">
                    <h1 className="text-4xl md:text-5xl font-bold text-white mb-12">Terms and Conditions</h1>
                    ...
                    <div className="space-y-8 text-sm md:text-base">
                        ...
                        <p>
                            This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://planedgearchitect.com/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
                        </p>
                        <p>
                            The Platform is owned by H K ENTERPRISES, a company incorporated under the Companies Act, 1956 with its registered office at ambika ram, ground floor, beside tulsi market Ranchi jora talab road ,Ranchi ,India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
                        </p>
                        <p>
                        ...
                        <ul className="list-disc pl-6 space-y-4">
                            ...
                            <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Ranchi and Jharkhand.</li>
                        </ul>
                        <p>
